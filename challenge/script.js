function clearAll() {
  ...
  memeClear.innerHTML = '';
  jokeClear.innerHTML = '';
  quoteClear.innerHTML = '';
  riddleClear.innerHTML = '';
}
...
function showQuote() {
  ...
  const qouteContainer = document.querySelector('.quote-content')
  ...
  qouteContainer.appendChild(quote);
  qouteContainer.appendChild(author);
}
...
function revealAnswers() {
  ...
  if (riddle && answer.hidden) {
    ...
    alert("The is no riddle to reveal the answer")
  }
}
